...
export const ExportPlugin = () => {
  ...
  const exportJson = useCallback(
    (title: string) => {
      const content = converter.current.convertFromSuperStringToFormat(JSON.stringify(editor.getEditorState()), 'json')
  ...
  const exportMarkdown = useCallback(
    (title: string) => {
      const content = converter.current.convertFromSuperStringToFormat(JSON.stringify(editor.getEditorState()), 'md')
  ...
  const exportHtml = useCallback(
    (title: string) => {
      const content = converter.current.convertFromSuperStringToFormat(JSON.stringify(editor.getEditorState()), 'html')
